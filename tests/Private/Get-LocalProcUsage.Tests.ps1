...
Describe "Get-LocalProcUsage function for $script:ModuleName" -Tags Build {
    It "Should return False if -WhatIf is used." {
        Get-LocalProcUsage -WhatIf | Should be $false
    }
    It "Should Return true." {
        ...
        Get-LocalProcUsage -Count 5 | Should not be $null
    }
    It "Should Return true." {
        Mock -CommandName 'Get-Process' -MockWith {
            $RawReturn = @(
    ...
    It "Should Return true." {
        ...
        Get-LocalProcUsage | Should not be $null
    }
    It "Should Return true." {
        Mock -CommandName 'Get-Process' -MockWith {
            $RawReturn = @(
        ...
        { Get-LocalProcUsage } | Should not Throw
    }
    It "Should Return true." {
        Mock -CommandName 'Get-Process' -MockWith {
        ...
        { Get-LocalProcUsage } | Should Throw
    }
}
